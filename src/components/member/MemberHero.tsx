    ...
    return (
        <section style={{ position: 'relative', width: '100%', height: '80vh', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'flex-start', marginTop: '4rem' }}>
            ...
            <div style={{ color: '#fff', textAlign: 'left', zIndex: '2', maxWidth: '700px', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'flex-start', height: '100%', paddingLeft: '7rem' }}>
                <p style={{ fontSize: '1.2rem', fontWeight: '700', color: '#ffffffff', marginBottom: '0px' }}>MEMBERSHIP</p>
                <h1 style={{ fontSize: '4rem', fontWeight: '700', marginBottom: '0px', marginTop: '0px', color: '#ffffffff', lineHeight: '1.2'}}>CAPAI TUJUANMU BERSAMA KAMI</h1>
                <p style={{ fontSize: '1rem', color: '#ffffffff', textShadow: '0 1px 4px rgba(0,0,0,0.18)', lineHeight: '1.4' }}>
                    Bergabunglah dengan FitHza Indonesia hanya dari Rp 150.000 per bulan.
                </p>
            </div>
        </section>
    );
