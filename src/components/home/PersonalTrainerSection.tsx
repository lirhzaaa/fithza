    ...
    return (
        <section style={{ position: 'relative', width: '100%', height: '70vh', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'flex-start', padding: '0 5rem' }}>
            ...
            <div
                ...
                style={{ position: 'relative', color: '#fff', textAlign: 'left', zIndex: '2', maxWidth: '750px', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'flex-start', height: '100%', padding: '0 clamp(1rem, 5vw, 5rem)' }}>
