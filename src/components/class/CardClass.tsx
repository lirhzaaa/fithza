...
const CardClass: React.FC = () => {
    const styles: { [key: string]: CSSProperties } = {
        ...
        h2: { textAlign: 'left', fontSize: '2.5rem', margin: '0 50px 10px', color: '#333' },
        subtitle: { textAlign: 'left', fontSize: '1.1rem', color: '#666', margin: '0 50px 40px', lineHeight: '1.6' },
        classCategoryWrapper: { display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '20px', margin: '0 50px' },
        ...
        <div style={styles.section}>
            <div style={styles.container}>
                <h2
                    ...
                    style={styles.h2}>Nikmati berbagai kelas favoritmu</h2>
                <p
                    data-aos="fade-right"
                    data-aos-duration="1000"
                    style={styles.subtitle}>Tubuh makin FIT &amp; olahraga makin seru dengan kelas berkelompok. Akses ke 50+ variasi kelas ini sudah termasuk dalam paket membership, jadi kamu bebas memilih kelas semaumu.</p>
                <div
