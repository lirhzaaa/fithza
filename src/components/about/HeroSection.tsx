    ...
    return (
        <section style={{ position: 'relative', width: '100%', height: '70vh', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'flex-start', marginTop: '4rem' }}>
            ...
            <div
                ...
                <p style={{ fontSize: 'clamp(1rem, 3vw, 1.2rem)', fontWeight: '700', color: '#ffffffff', marginBottom: '0px' }}>TENTANG KAMI</p>
                <h1 style={{ fontSize: 'clamp(2rem, 8vw, 4rem)', fontWeight: '700', marginBottom: '0px', marginTop: '0px', color: '#ffffffff', lineHeight: '1.2' }}>JADILAH BAGIAN DARI KAMI</h1>
