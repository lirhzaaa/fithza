        ...
        <div>
            ...
            <div style={styles.descSection}>
                <div style={styles.descContainer}>
                    <div>
                        <h2 style={styles.descTitle}>Tingkatkan Kekuatan Tubuhmu dengan Strength Class</h2>
            ...
            <div style={styles.section}>
                <div style={styles.container}>
                    <h2 style={styles.title}>Eksplor Kelas Strength</h2>
            ...
            <div style={styles.faqSection}>
                <div style={styles.faqContainer}>
                    <h2 style={styles.faqTitle}>FAQ Strength Class</h2>
